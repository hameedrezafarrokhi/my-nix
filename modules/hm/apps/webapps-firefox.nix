...
let
  ...
  gepiti = pkgs.writeShellScriptBin "GPT" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://chatgpt.com/
  '';
  grok = pkgs.writeShellScriptBin "grok" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://grok.com/
  '';
  deepseek = pkgs.writeShellScriptBin "deepseek" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.deepseek.com/en
  '';
  claude-code = pkgs.writeShellScriptBin "claude-code" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.anthropic.com/
  '';


  # Nix
  nix-packages = pkgs.writeShellScriptBin "nix-packages" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://search.nixos.org/packages?channel=unstable&
  '';
  nix-options = pkgs.writeShellScriptBin "nix-options" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://search.nixos.org/options?channel=unstable&
  '';
  nix-status = pkgs.writeShellScriptBin "nix-status" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://status.nixos.org/
  '';
  nix-hydra = pkgs.writeShellScriptBin "nix-hydra" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://hydra.nixos.org/jobset/nixos/trunk-combined
  '';
  nix-wiki = pkgs.writeShellScriptBin "nix-wiki" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://wiki.nixos.org/wiki/NixOS_Wiki
  '';
  nix-github = pkgs.writeShellScriptBin "nix-github" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://github.com/NixOS/nixpkgs
  '';
  arch-wiki = pkgs.writeShellScriptBin "arch-wiki" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://wiki.archlinux.org/title/Main_page
  '';
  repology = pkgs.writeShellScriptBin "repology" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://repology.org/projects/?search=
  '';


  # Email
  gmail = pkgs.writeShellScriptBin "Gmail" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://mail.google.com/
  '';
  yahoo-mail = pkgs.writeShellScriptBin "yahoo-mail" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://mail.yahoo.com/
  '';
  proton-mail = pkgs.writeShellScriptBin "Proton-mail" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://proton.me/mail
  '';


  # Search
  google = pkgs.writeShellScriptBin "google" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.google.com
  '';
  duckduckgo = pkgs.writeShellScriptBin "ddgo" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://duckduckgo.com/
  '';
  brave-search = pkgs.writeShellScriptBin "brave-search" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://search.brave.com/
  '';
  bing-search = pkgs.writeShellScriptBin "bing-search" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.bing.com/
  '';
  yahoo = pkgs.writeShellScriptBin "yahoo" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.yahoo.com/
  '';
  wikipedia = pkgs.writeShellScriptBin "wikipedia" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.wikipedia.org/
  '';
  google-images = pkgs.writeShellScriptBin "google-images" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://images.google.com/
  '';
  imdb = pkgs.writeShellScriptBin "imdb" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.imdb.com/
  '';


  # Video
  youtube = pkgs.writeShellScriptBin "YouTube" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.youtube.com/
  '';
  twitch = pkgs.writeShellScriptBin "TwitchTV" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.twitch.tv/
  '';
  iran-tv = pkgs.writeShellScriptBin "iran-tv" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://telewebion.com/channels
  '';


  # Audio
  spotify = pkgs.writeShellScriptBin "Spotify-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.spotify.com/
  '';
  pandora = pkgs.writeShellScriptBin "Pandora-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.pandora.com/
  '';
  soundcloud = pkgs.writeShellScriptBin "SoundCloud-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://soundcloud.com/
  '';
  youtube-music = pkgs.writeShellScriptBin "ytMusic-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://music.youtube.com/
  '';
  radio-online = pkgs.writeShellScriptBin "iHeart-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.iheart.com/podcast/
  '';


  # Social
  whatsapp-web = pkgs.writeShellScriptBin "Whatsapp-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://web.whatsapp.com/
  '';
  instagram-web = pkgs.writeShellScriptBin "Instagram-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.instagram.com/
  '';
  facebook = pkgs.writeShellScriptBin "Facebook-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.facebook.com/
  '';
  twitter-x = pkgs.writeShellScriptBin "X-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://x.com/
  '';
  zoom-web = pkgs.writeShellScriptBin "Zoom-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.zoom.com/
  '';
  discord-web = pkgs.writeShellScriptBin "Discord-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://discord.com/
  '';
  reddit-web = pkgs.writeShellScriptBin "Reddit-Web" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.reddit.com/
  '';


  # Game
  online-games = pkgs.writeShellScriptBin "Online-Games" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.crazygames.com/
  '';
  play-ps2 = pkgs.writeShellScriptBin "Play-PS2" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://purei.org/
  '';
  epic-games = pkgs.writeShellScriptBin "Epic-Gmaes" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://store.epicgames.com/en-US
  '';
  google-games = pkgs.writeShellScriptBin "Google-Games" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://sites.google.com/site/populardoodlegames/home
  '';
  roblox = pkgs.writeShellScriptBin "Roblox" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.roblox.com/
  '';
  yahoo-games = pkgs.writeShellScriptBin "Yahoo-Games" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.yahoo.com/games/
  '';


  # Medical
  up-to-date = pkgs.writeShellScriptBin "up-to-date" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.uptodate.com/
  '';
  medscape = pkgs.writeShellScriptBin "medscape" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.medscape.com/
  '';
 ...
 #'';
  ...
  google-photos = pkgs.writeShellScriptBin "google-photos" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://photos.google.com/
  '';
  dropbpx = pkgs.writeShellScriptBin "Dropbox" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.dropbox.com/
  '';
  borg-base = pkgs.writeShellScriptBin "BorgBase" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.borgbase.com/repositories
  '';


  # Productivity
  photoshop = pkgs.writeShellScriptBin "PhotoShop" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://photoshop.adobe.com/
  '';
  office365 = pkgs.writeShellScriptBin "office365" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.office.com/
  '';
  boxySVG = pkgs.writeShellScriptBin "BoxySVG" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://boxy-svg.com/app
  '';


  # World
  google-maps = pkgs.writeShellScriptBin "google-maps" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.google.com/maps
  '';
  google-earth = pkgs.writeShellScriptBin "google-earth" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://earth.google.com/web/
  '';
  weather-online = pkgs.writeShellScriptBin "weather-online" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.accuweather.com/en/ir/tehran/210841/weather-forecast/210841
  '';
  time-ir = pkgs.writeShellScriptBin "time-ir" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://www.time.ir/
  '';


  # Bills
  irancell = pkgs.writeShellScriptBin "irancell" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://my.irancell.ir/
  '';
  hamrah = pkgs.writeShellScriptBin "hamrah" ''
    ${lib.getExe config.my.default.browser-package} --new-window https://my.mci.ir/
  '';
