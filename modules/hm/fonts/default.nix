...

{
  ...
  config = lib.mkIf cfg.enable {
   ...
   #    mkdir -p "$HOME/.local/share/fonts/noto"
   #    cp -rn ${pkgs.noto-fonts}/share/fonts/noto/* $HOME/.local/share/fonts/noto/
   ...
   #    mkdir -p "$HOME/.local/share/fonts/roboto-serif/truetype"
   #    cp -rn ${pkgs.roboto-serif}/share/fonts/truetype/* "$HOME/.local/share/fonts/roboto-serif/truetype/"
