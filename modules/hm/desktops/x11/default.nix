...
let
  ...
  xworkspace-notif = pkgs.writeShellScriptBin "xworkspace-notif" ''
    # Credits: https://codeberg.org/unixextremist/para
 ...
 #cursor-shake = pkgs.callPackage ../../../nixos/myPackages/x11_shake_to_magnify_cursor.nix { };
  cursor-shake = pkgs.callPackage ../../../nixos/myPackages/cursor-shake-zoom/cursor-shake-zoom.nix { };
...

{
  ...
  config = lib.mkIf cfg.enable {
   ...
   #));
    ...
    xdg.configFile."cursor-scaler/config.conf" = {
      text = ''
...
svg_path = "/run/current-system/sw/share/icons/catppuccin-macchiato-sapphire-cursors/cursors_scalable/left_ptr/default.svg"
