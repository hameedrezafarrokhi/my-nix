...
{ config = lib.mkIf (config.my.kde.appletrc == "red") {
  ...
  home.activation = {
   ...
   #'';
    ...
    PlasmaAppletsrcRed = lib.hm.dag.entryAfter ["writeBoundary"] ''
      ...
      rm -f "${nix-path}/modules/hm/desktops/kde/appletrc/red/plasma-org.kde.plasma.desktop-appletsrc.backup"
      cp "${nix-path}/modules/hm/desktops/kde/appletrc/red/plasma-org.kde.plasma.desktop-appletsrc" "${nix-path}/modules/hm/desktops/kde/appletrc/red/plasma-org.kde.plasma.desktop-appletsrc.backup"
