...
* `rcmaster` - Horizontal Center Master layout
```
_______________
|____|____|___|
|             |
...
* `hdmaster` - Horizontal Double Stack layout
```
_______________
|             |
|_____________|
