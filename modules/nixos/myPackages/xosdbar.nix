...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ libx11 xosd ];

  buildPhase = ''
    gcc -Wall -o xosdbar xosdbar.c -lxosd
  '';

  installPhase = ''
    install -Dm755 xosdbar $out/bin/xosdbar
  '';

  meta = {
    homepage = "https://github.com/minad/xosdbar";
    description = "wrapper for xosd with live update";
    maintainers = [ ];
