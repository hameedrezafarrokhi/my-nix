{
  ...
  fetchurl,
  version ? "test",
  hash ? "sha256-GX9HFC3HyRiORL3/cjxD0Dk91cafqHBaBpzioXc8iko=",
...
let
  ...
  src = fetchurl {
    url = "https://github.com/tsoding/musializer/releases/download/appimage-test/Musializer-x86_64.AppImage";
    inherit hash;
  };
