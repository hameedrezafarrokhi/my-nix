...
#define MTP_MOUNT_SHELL_CMD   "echo hello"
#define MTP_UNMOUNT_SHELL_CMD "notify-send hello"
...
#define MTP_AUTO_SPAWN_SCRCPY 0   /* launch scrcpy automatically whenever a phone is detected */
