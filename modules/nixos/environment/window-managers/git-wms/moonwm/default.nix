...
static int closeswallowed			= 0;		/* close swallowed terminal after child exits */
...
static Key keys[] = {
    ...
    { 0,    XF86XK_MonBrightnessDown,   spawn,           SHCMD("pademelon-tools backlight --dec 5") },
    { 0,    XF86XK_MonBrightnessUp,     spawn,           SHCMD("pademelon-tools backlight --inc 5") },
    /* SCREENSHOTS */
    { MODKEY,               XK_Print,   spawn,           SHCMD("moonwm-utils screenshot") },
    ...
    { MODKEY,               XK_F5,      spawn,           SHCMD("moonwm-utils xrdb") },
...
static Button buttons[] = {
    ...
    { ClkLtSymbol,          0,              Button6,        cyclelayout,    {.i = -1} },
    { ClkLtSymbol,          0,              Button7,        cyclelayout,    {.i = +1} },
